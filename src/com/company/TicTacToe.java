...
public class TicTacToe extends JComponent {
    public static final int FIELD_EMPTY = 0; // пустое значение
    public static final int FIELD_X = 10; // X
    public static final int FIELD_O = 200; // O
    ...
    protected void processMouseEvent(MouseEvent mouseEvent) {
        ...
        if (mouseEvent.getButton() == MouseEvent.BUTTON1){
            ...
            if (field[i][j] == FIELD_EMPTY){
                ...
                if (res != 0){
                    if (res == FIELD_O * 3){
                        JOptionPane.showMessageDialog(this,"Победа! нолик");
                    }else if (res == FIELD_X * 3){
                        JOptionPane.showMessageDialog(this, "Победа! крестик");
                    }else {
    ...
    void drawGrid (Graphics graphics){
        int w = getWidth(); // ширена
        int h = getHeight(); // высота
        int dw = w / 3; // делим ширену на 3 и получаем одну ячейку
        int dh = h / 3;//делим высоту на 3 и получаем одну ячейку
